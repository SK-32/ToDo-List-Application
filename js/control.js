!(function(t) {
  ...
  (t.expr[":"].notmdproc = function(o) {
    ...
    input: function(o) {
      t(o ? o : this.options.inputElements)
        ...
        .each(function() {
          ...
          0 === i.length &&
            (o.wrap("<div class='form-group'></div>"), (i = o.closest(
              ".form-group"
          ...
          if (
            ...
            var a = o.attr("id"), r = "";
            a && (r = "for='" + a + "'"), i.addClass("label-floating"), o.after(
      ...
      t(document)
        ...
        .on("keyup change", ".form-control", function() {
          var o = t(this),
            ...
            e =
              "undefined" == typeof o[0].checkValidity || o[0].checkValidity();
          "" === o.val()
            ? i.addClass("is-empty")
            : i.removeClass(
                "is-empty"
        ...
        .on(
          ...
          function() {
            ...
            t.each(this.files, function(t, o) {
              n += o.name + ", ";
            }), (n = n.substring(0, n.length - 2)), n
              ? i.removeClass("is-empty")
              : i.addClass("is-empty"), i
              .find("input.form-control[readonly]")
              .val(n);
          }
        );
    },
    ...
    init: function(o) {
      ...
      var i = t(document);
      t.fn.ripples && this.options.ripples && this.ripples(), this.options
        .input && (this.input(), this.attachInputEventHandlers()), this.options
        .checkbox && this.checkbox(), this.options.togglebutton &&
        this.togglebutton(), this.options.radio && this.radio(), this.options
        .autofill &&
        (this.autofill(), this.attachAutofillEventHandlers()), document.arrive &&
        this.options.arrive &&
        (t.fn.ripples &&
  ...
  "use strict";
  function e(o, i) {
    (r = this), (this.element = t(o)), (this.options = t.extend(
      {},
      s,
      i
    )), (this._defaults = s), (this._name = a), this.init();
  }
  ...
  (e.prototype.init = function() {
    ...
    i.on("mousedown touchstart", function(n) {
      if (!r.isTouch() || "mousedown" !== n.type) {
        ...
        if (a || s) {
          ...
          p
            .addClass("ripple")
            .css({ left: s, top: a, "background-color": l }), e.append(
            p
          ), (function() {
    ...
    var i = t.offset();
    return r.isTouch()
      ? ((o = o.originalEvent), 1 === o.touches.length
          ? o.touches[0].pageX - i.left
          : !1)
      : o.pageX - i.left;
